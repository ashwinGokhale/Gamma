...
export const findRepos = (bases: string[], dotfile: {}) => {
	let repo_names = {};
	bases.forEach(base => {
...
export const processContextBase = (base: string, dotfile: {}) => {
...
export const processContextRepo = (repo: string, dotfile: {}) => {
	// Sets the base as the context base
...
export const runCommand = (command: string, dotfile: {}) => {
...
export const getDotfile = (): [Dotfile, boolean] => {
...
export const dumpDotfile = (dotfile: Dotfile) => {
